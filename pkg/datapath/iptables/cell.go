...
type Config struct {
	...
	// IPv4MasqueradeSrcExclusionCIDR for source IPs that should be excluded from masquerading
	IPv4MasqueradeSrcExclusionCIDR string

	// IPv6MasqueradeSrcExclusionCIDR for source IPs that should be excluded from masquerading
	IPv6MasqueradeSrcExclusionCIDR string
}
...
var defaultConfig = Config{
	...
	IPv4MasqueradeSrcExclusionCIDR: "",
	IPv6MasqueradeSrcExclusionCIDR: "",
}
...
func (def Config) Flags(flags *pflag.FlagSet) {
	...
	flags.String("ipv4-masquerade-src-exclusion-cidr", def.IPv4MasqueradeSrcExclusionCIDR, "IPv4 CIDR for source IPs that should be excluded from masquerading")
	flags.String("ipv6-masquerade-src-exclusion-cidr", def.IPv6MasqueradeSrcExclusionCIDR, "IPv6 CIDR for source IPs that should be excluded from masquerading")
}
